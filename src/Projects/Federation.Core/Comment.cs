...
namespace Federation.Core
{
    public partial class Comment
    {
        ...
        public virtual ICollection<Comment> ChildComments
        {
            get
            {
                if (_childComments == null)
                {
                    var newCollection = new FixupCollection<Comment>();
                    newCollection.CollectionChanged += FixupChildComments;
                    _childComments = newCollection;
                }
                return _childComments;
            }
            set
            {
                if (!ReferenceEquals(_childComments, value))
                {
                    var previousValue = _childComments as FixupCollection<Comment>;
                    if (previousValue != null)
                    {
                        previousValue.CollectionChanged -= FixupChildComments;
                    }
                    _childComments = value;
                    var newValue = value as FixupCollection<Comment>;
                    if (newValue != null)
                    {
                        newValue.CollectionChanged += FixupChildComments;
                    }
                }
            }
        }
        private ICollection<Comment> _childComments;
        ...
        private void FixupChildComments(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (e.NewItems != null)
            {
