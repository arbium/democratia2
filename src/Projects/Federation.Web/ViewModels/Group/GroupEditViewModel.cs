    ...
    public class GroupEditViewModel
    {
        ...
        public GroupEditViewModel(Group group)
        {
            if (group != null)
            {
                ...
                ElectionFrequency = group.ElectionFrequency;
                Label = group.Label;
                ModeratorsCount = group.ModeratorsCount;
                Name = group.Name;
                ParentGroupId = group.ParentGroupId ?? Guid.Empty;
                Summary = group.Summary;
                PollQuorum = group.PollQuorum;
                ElectionQuorum = group.ElectionQuorum;

                if (group.Categories.Count > 0)
                    Category = group.Categories.First().Id;
